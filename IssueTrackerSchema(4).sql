...
IS 
BEGIN
--according to different search string, execute different sql query.
  IF searchType=1 THEN
    OPEN cusorIssue FOR
      SELECT DISTINCT TITLE,i.CREATOR,i.DESCRIPTION,i.ID,i.RESOLVER,i.VERIFIER,i.UserVersionID FROM A3_USER u JOIN A3_ISSUE i ON
